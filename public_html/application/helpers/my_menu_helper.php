...
if ( ! function_exists('cargar_menu_principal')){
  function cargar_menu_principal($perfil) {
    ...
    switch($pag) {
      ...
      case 'c_bloques': $men_pri[3] = ' active open'; $men_sub[28] = ' active'; $men_ter[3] = ' show'; $men_cua[3] = ''; break;
      ...
      $salida .= '
        <li class="nav-item '.$men_pri[1].'">
          <a href="#" class="nav-link dropdown-toggle '.$men_cua[1].'">
            ...
            <span class="nav-text fadeable"><span>Gestión de Personal</span></span>
            <b class="caret fa fa-angle-left rt-n90"></b>
          </a>
        ...
        <li class="nav-item '.$men_pri[3].'">
          ...
          <div class="hideable submenu collapse '.$men_ter[3].'">
            <ul class="submenu-inner">
              ...
              <li class="nav-item '.$men_sub[28].'">'.anchor(('c_programacion/bloques'),'<span class="nav-text"><span>Bloques</span></span>','class="nav-link"').'</li>
              <li class="nav-item '.$men_sub[43].'">'.anchor(('c_seguimientocx/index'),'<span class="nav-text"><span>Curso Quirurgico</span></span>','class="nav-link"').'</li>
            </ul>
          </div>
          <b class="sub-arrow"></b>
        </li>';
    ...
    if($perfil == 4) {
       ...
       $salida .= '
        <li class="nav-item '.$men_pri[2].'">
          ...
          <div class="hideable submenu collapse '.$men_ter[2].'">
            <ul class="submenu-inner">
              <li class="nav-item '.$men_sub[22].'">'.anchor(('d_doc_institucionales/index'),'<span class="nav-text"><span>Documenetos Institucionales</span></span>','class="nav-link"').'</li>
              <li class="nav-item '.$men_sub[23].'">'.anchor(('d_consultas/index'),'<span class="nav-text"><span>Consultas</span></span>','class="nav-link"').'</li>
            </ul>
          </div>
          <b class="sub-arrow"></b>
        ...
        <li class="nav-item '.$men_pri[5].'">
            ...
            <div class="hideable submenu collapse '.$men_ter[5].'">
              <ul class="submenu-inner">
                <li class="nav-item '.$men_sub[37].'">'.anchor(('capacitaciones/index'),'<span class="nav-text"><span>Capacitaciones</span></span>','class="nav-link"').'</li>
                <li class="nav-item '.$men_sub[38].'">'.anchor(('evaluaciones/index'),'<span class="nav-text"><span>Evaluaciones</span></span>','class="nav-link"').'</li>
                <li class="nav-item '.$men_sub[47].'">'.anchor(('medicamentos/gestion'),'<span class="nav-text"><span>Citas Medicamentos</span></span>','class="nav-link"').'</li>
              </ul>
            </div>
          <b class="sub-arrow"></b>
        </li>';
