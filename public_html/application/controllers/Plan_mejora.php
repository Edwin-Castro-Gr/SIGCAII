...
class Plan_mejora extends CI_Controller
{
    ...
    public function index()
    {
        if (!defined('CON_id_usuario') && $this->session->userdata('C_id_usuario') == "") {
            ...
            $data_usua['contenido'] = 'plan_mejora/index';
    ...
    public function cargar_inf_nocumple()
    {
        if (!defined('CON_id_usuario') && $this->session->userdata('C_id_usuario') == "")
            ...
            if (!$this->input->is_ajax_request()) {
                ...
                $campos = 'rp.id_respuesta AS "Id", DATE(rg.fecha_insp) AS "Fecha Inspección", r.nombre AS "Ronda", s.nombre AS "Servicio", rs.nombre AS "Sección", rq.nombre AS "Pregunta", IFNULL(rer.imagen, " ") AS "Evidencia"';

               
                if ($id_ronda != "00" && $id_servicio != "00" && $fechaini != "" && $fechafin != ""){
                    $query = $this->general_model->consulta_personalizada($campos, 'rondas_gestion_resp rp INNER JOIN rondas_gestion rg ON rg.id_gestion = rp.id_gestion INNER JOIN rondas r ON rg.id_ronda = r.id_ronda INNER JOIN servicios s ON rg.id_servicio = s.id_servicio INNER JOIN rondas_preguntas rq ON rp.id_pregunta = rq.id_items INNER JOIN rondas_seccion rs ON rq.id_seccion = rs.id_seccion LEFT JOIN rondas_evidencia_resp rer ON rp.id_respuesta = rer.id_respuesta', 'rp.respuesta = 0 AND rg.id_ronda = "' . $id_ronda . '" AND rg.id_servicio = "' . $id_servicio . '" AND DATE(rg.fecha_insp) BETWEEN "'.$fechaini.'" AND "'.$fechafin.'"', 'rg.fecha_insp', 0, 0);

                }else if ($id_ronda != "00" && $id_servicio != "00" && $fechaini == "" && $fechafin == ""){
                    $query = $this->general_model->consulta_personalizada($campos, 'rondas_gestion_resp rp INNER JOIN rondas_gestion rg ON rg.id_gestion = rp.id_gestion INNER JOIN rondas r ON rg.id_ronda = r.id_ronda INNER JOIN servicios s ON rg.id_servicio = s.id_servicio INNER JOIN rondas_preguntas rq ON rp.id_pregunta = rq.id_items INNER JOIN rondas_seccion rs ON rq.id_seccion = rs.id_seccion LEFT JOIN rondas_evidencia_resp rer ON rp.id_respuesta = rer.id_respuesta', 'rp.respuesta = 0 AND rg.id_ronda = "' . $id_ronda . '" AND rg.id_servicio = "' . $id_servicio . '"', 'rg.fecha_insp', 0, 0);

                }else if($id_ronda != "00" && $id_servicio == "00" && $fechaini == "" && $fechafin == ""){
                    $query = $this->general_model->consulta_personalizada($campos, 'rondas_gestion_resp rp INNER JOIN rondas_gestion rg ON rg.id_gestion = rp.id_gestion INNER JOIN rondas r ON rg.id_ronda = r.id_ronda INNER JOIN servicios s ON rg.id_servicio = s.id_servicio INNER JOIN rondas_preguntas rq ON rp.id_pregunta = rq.id_items INNER JOIN rondas_seccion rs ON rq.id_seccion = rs.id_seccion LEFT JOIN rondas_evidencia_resp rer ON rp.id_respuesta = rer.id_respuesta', 'rp.respuesta = 0 AND rg.id_ronda = "' . $id_ronda . '"', 'rg.id_ronda', 0, 0);  

                }else if ($id_ronda == "00" && $id_servicio != "00" && $fechaini == "" && $fechafin == ""){
                    $query = $this->general_model->consulta_personalizada($campos, 'rondas_gestion_resp rp INNER JOIN rondas_gestion rg ON rg.id_gestion = rp.id_gestion INNER JOIN rondas r ON rg.id_ronda = r.id_ronda INNER JOIN servicios s ON rg.id_servicio = s.id_servicio INNER JOIN rondas_preguntas rq ON rp.id_pregunta = rq.id_items INNER JOIN rondas_seccion rs ON rq.id_seccion = rs.id_seccion LEFT JOIN rondas_evidencia_resp rer ON rp.id_respuesta = rer.id_respuesta', 'rp.respuesta = 0 AND rg.id_servicio = "' . $id_servicio . '"', 'rg.id_servicio', 0, 0);

                }else if ($id_ronda == "00" && $id_servicio == "00" && $fechaini != "" && $fechafin != ""){
                    $query = $this->general_model->consulta_personalizada($campos, 'rondas_gestion_resp rp INNER JOIN rondas_gestion rg ON rg.id_gestion = rp.id_gestion INNER JOIN rondas r ON rg.id_ronda = r.id_ronda INNER JOIN servicios s ON rg.id_servicio = s.id_servicio INNER JOIN rondas_preguntas rq ON rp.id_pregunta = rq.id_items INNER JOIN rondas_seccion rs ON rq.id_seccion = rs.id_seccion LEFT JOIN rondas_evidencia_resp rer ON rp.id_respuesta = rer.id_respuesta', 'rp.respuesta = 0 AND DATE(rg.fecha_insp) BETWEEN "'.$fechaini.'" AND "'.$fechafin.'"', 'rg.fecha_insp', 0, 0);  

                }else if ($id_ronda != "00" && $id_servicio == "00" && $fechaini != "" && $fechafin != ""){
                    $query = $this->general_model->consulta_personalizada($campos, 'rondas_gestion_resp rp INNER JOIN rondas_gestion rg ON rg.id_gestion = rp.id_gestion INNER JOIN rondas r ON rg.id_ronda = r.id_ronda INNER JOIN servicios s ON rg.id_servicio = s.id_servicio INNER JOIN rondas_preguntas rq ON rp.id_pregunta = rq.id_items INNER JOIN rondas_seccion rs ON rq.id_seccion = rs.id_seccion LEFT JOIN rondas_evidencia_resp rer ON rp.id_respuesta = rer.id_respuesta', 'rp.respuesta = 0 AND rg.id_ronda = "' . $id_ronda . '" AND DATE(rg.fecha_insp) BETWEEN "'.$fechaini.'" AND "'.$fechafin.'"', 'rg.fecha_insp', 0, 0);                
                }else {
                    $query = $this->general_model->consulta_personalizada($campos, 'rondas_gestion_resp rp INNER JOIN rondas_gestion rg ON rg.id_gestion = rp.id_gestion INNER JOIN rondas r ON rg.id_ronda = r.id_ronda INNER JOIN servicios s ON rg.id_servicio = s.id_servicio INNER JOIN rondas_preguntas rq ON rp.id_pregunta = rq.id_items INNER JOIN rondas_seccion rs ON rq.id_seccion = rs.id_seccion LEFT JOIN rondas_evidencia_resp rer ON rp.id_respuesta = rer.id_respuesta', 'rp.respuesta = 0', 'rg.id_ronda', 0, 0);    
                }
                ...
                foreach ($query->result_array() as $row)
                {
                    ...
                    $tabla .= '<td class="text-nowrap"><div class="action-buttons">
                            <a href="#" class="text-green-m1 mx-1" data-toggle="tooltip" data-original-title="Detalle" id="btndetalle_' . $row['Id'] . '"> <i id="btndetalle_' . $row['Id'] . '" class="fa fa-book-open text-105"></i> </a>';

                    if($row['Evidencia']!= " "){
                        $tabla .=  '<a href="#" class="text-blue mx-1" data-toggle="tooltip" data-original-title="Evidencia" aria-describedby="tooltip' . $row['Id'] . '" id="btnEvidencia_' . $row['Evidencia'] . '"> <i  id="btnEvidencia_' . $row['Evidencia'] . '" class="fa fa-file-image text-105"></i> </a>';
                    }           

                    $tabla .=  '<a href="#" class="text-danger mx-1" data-toggle="tooltip" data-original-title="Acción Mejora" aria-describedby="tooltip' . $row['Id'] . '" id="btnMejora_' . $row['Id'] . '"> <i  id="btnMejora_' . $row['Id'] . '" class="fa fa-edit text-105"></i> </a>';
    ...
    public function guardar_gestion()
    {
        if (!defined('CON_id_usuario') && $this->session->userdata('C_id_usuario') == "")
            ...
            // ################################## SECCION RECORRER EL CONTENIDO DEL INPUT FILE Y GUARDAR LOS DATOS EN BD ##################################    
                ...
                //         if($this->upload->do_upload('evidencia2['.$i.']')){
