			...
			if(!$this->input->is_ajax_request()) {
			    ...
			    {      
			    	...
			    	$accordion .='<div class="form-group row" id="div_archivo'.$row['Id'].'">
		                          	<div class="col-sm-6 col-form-label text-sm-left pr-0">'.
		                            	form_label(''.$row['Nombre'],'archivo_'.$row['Id'].'', array('class'=>'mb-0')).'
		                          	</div>';
			        foreach ($query1->result_array() as $row1)
				    {
				    	$accordion .='<div class="col-sm-1" id="archivo_'.$row1['Id'].'">
                  	...
                  	$accordion .='</div>
                  					<div class="form-group row">
			                          	<div class="col-sm-2 col-form-label text-sm-right pr-0">'.
			                            	form_label('Fecha Documento ','fecha_inicio_'.$row['Id'], array('class'=>'mb-0')).'
			                          	</div>
		                          		<div class="col-sm-2">'.
		                            		form_input(array('type'=>'date', 'name'=>'fecha_inicio_'.$row['Id'], 'id'=>'fecha_inicio_'.$row['Id'], 'class'=>'form-control', 'value'=>$row['fechainicio'])).'
		                          		</div>
