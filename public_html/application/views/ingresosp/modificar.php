        ...
        <div class="col-12">
          <div class="card dcard">
            <div class="card-body px-3 pb-1">
              <?= form_open(base_url('c_ingresop/actualizar'), array('id'=>'form_actualizar', 'name'=>'form_actualizar', 'class'=>'mt-lg-3', 'autocomplete'=>'off')); ?>
...
<!-- 
                  ...
                  <div class="form-group row" id="div_funcionario">
                    ...
                    <div class="col-sm-2 col-form-label text-sm-right pr-0">
                      ...
                      <div class="col-sm-4">
                      <?= select_cargos_tabla('ingresop',$c_id_cargo,'select2 form-control" required="1');?>
                    </div>                   
                  </div>
