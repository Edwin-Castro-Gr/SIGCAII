            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="modalFormBody">
                    <form class="form-horizontal m-t-20" id="modalFormReporte">
                      <div class="form-group row" id="div_informesconsultaI">
                      	<div class="col-sm-2 col-form-label text-sm-right pr-0">
		                      <?= form_label('Informe','informe', array('class'=>'mb-0')); ?>
		                    </div>
		                    <div class="col-sm-10">
		                      <?= form_dropdown('informe', $opcinforme,'','class="form-control" id="informe"');?>
		                    </div>
		                  </div>
