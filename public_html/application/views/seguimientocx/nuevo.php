                ...
                <div class="form-body " style=" justify-content:flex-start;" >
                  <div class="card dcard">
                    ...
                    <div class="card-body px-2 pb-1">  
                      <div class="form-group row" id="div_paciente" >
                        ...
                        <div class="col-sm-5">
                          <?= form_input(array('type'=>'text', 'name'=>'paciente', 'id'=>'paciente', 'placeholder'=>'', 'class'=>'form-control col-sm-9 col-md-12 UpperCase'));?>
                        </div>
                      ...
                      <div class="form-group row" id="div_datosIIpaciente" >
                        ...
                        <div class="col-sm-2 col-form-label text-sm-right pr-0">
                          <?= form_label('Entidad','entidad_pacientes', array('class'=>'mb-0',)); ?>
                        </div>
                        <div class="col-sm-4">
                  ...
                  <div class="card dcard">
                    ...
                    <div class="form-group row" id="div_seccion2">
                      ...
                      <div class="col-sm-2">
                          <?= form_dropdown('sala', $opcsala, '', 'class="form-control" id="sala"');?>
                      </div>                   
                    </div>
                    ...
                    <div class="form-group row" id="div_tiempo">
                      ...
                      <div class="col-sm-4">
                        <?= select_ayudantes_tabla('programacion','','select2 form-control');?>
                      </div> 
                      <div class="col-sm-2 col-form-label text-sm-right pr-0">
                      ...
                      <div class="col-sm-1">
                        <?= form_dropdown('mat', $opcmat, '', 'class="form-control" id="mat"');?>
                      </div> 
                    </div>                  
                  </div>
                <br>               
