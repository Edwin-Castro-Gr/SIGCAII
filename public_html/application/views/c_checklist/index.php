...
<div class="card acard mt-2 mt-lg-3">
	<div class="card-header">
        <h3 class="card-title text-125 text-primary-d2">
          ...
          Checklist de Documentos Contratos
        </h3>
    </div>
	<div class="row mt-3">
		<div class="col-12">
			    ...
			    <!--form autocomplete="off"-->
			      <div class="d-flex justify-content-between flex-column flex-sm-row mb-3 px-2 px-sm-0">
			        ...
			        <div class="mb-2 mb-sm-0">
			          ...
			          <button type="button" class="btn btn-blue px-3 d-block text-95 radius-round border-2 brc-black-tp10" data-toggle="modal" data-target="#newModal" id="btn_nuevo_checklist">
			            <i class="fa fa-plus mr-1"></i>
			            <span class="d-sm-none d-md-inline" id="btn_nuevo_checklist">Nuevo</span>
			          </button>
			          </div>
			        </div>
			      </div>
				  ...
				  <div class="modal-dialog" role="document">
				    <div class="modal-content">
				      ...
				      <div class="modal-body">
				      	<?= form_open(base_url('c_checklist_doc/guardar'), array('id'=>'form_guardar', 'name'=>'form_guardar', 'class'=>'', 'autocomplete'=>'off')); ?>
				      		<?= form_input(array('type'=>'hidden', 'name'=>'idregistro', 'id'=>'idregistro', 'value'=>'0'));?>
				      		<?= form_input(array('type'=>'hidden', 'name'=>'idcargo', 'id'=>'idcargo', 'value'=>''));?>
				      		<?= form_input(array('type'=>'hidden', 'name'=>'idtipocontrato', 'id'=>'idtipocontrato', 'value'=>''));?>
				      		<?= form_input(array('type'=>'hidden', 'name'=>'idlistadodocumento[]', 'id'=>'idlistadodocumentos', 'value'=>''));?>
					        <div class="card-body px-3 pb-1">
	                	<div class="form-body">
			                <div class="form-group row" id="div_tipo">
		                    <div class="col-sm-2 col-form-label text-sm-right pr-0">
		                      <?= form_label('Tipo Contrato *','tiposcontratos_checklist', array('class'=>'mb-0')); ?>
		                    </div>
		                    <div class="col-sm-10">
		                      <?= select_tiposcontratos_tabla('checklist','','form-control');?>
		                    </div>                    		                  
		                  </div>
		                   <div class="form-group row" id="div_tipo">
		                    
                    		<div class="col-sm-2 col-form-label text-sm-right pr-0">
                      		<?= form_label('Cargo *','cargos_checklist', array('class'=>'mb-0')); ?>
                   			</div>
                      	<div class="col-sm-10">
                      		<?= select_cargos_tabla('checklist','','select2 form-control" required="1');?>
                    		</div>	                   
		                  </div>

		                  <div class="form-group row" id="div_listaDocumentos">

		                  </div> 	

		                  <div class="form-group row" id="div_seccion2">
		                    <div class="col-sm-2 col-form-label text-sm-right pr-0">
		                      <?= form_label('Agregar Documentos','ck_agregar', array('class'=>'mb-0','id'=>'lblck_agregar')); ?>
		                    </div>
		                    <div class="col-sm-3">                     
		                      <label class="col-form-label">
		                       No
		                      </label>
		                        <?= form_input(array('type'=>'checkbox', 'name'=>'ck_agregar', 'id'=>'ck_agregar', 'class'=>'ace-switch input-md text-grey-l1 brc-primary-d1'));?>                        
		                      <label class="col-form-label">
		                        Si 
		                      </label>
		                    </div>
