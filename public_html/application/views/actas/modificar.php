              ...
              <div class="form-group row" id="div_tipo" >
                ...
                <div class="form-group row" id="div_aso_documentos">                            
                  ...
                  <div class="col-sm-4 " id='divdoc_relacionado' >                    
                      <?= form_dropdown('doc_relacionado[]','',$c_documento_relacionado, 'class="select2 form-control"  multiple="multiple" id="doc_relacionado"');?>
                  </div>                                   
                </div>
                ...
                <div class="form-group row" id="div_archivov">
                  ...
                  <div class="col-sm-9">
                   <?= form_upload(array('type'=>'file', 'name'=>'archivoorig', 'id'=>'archivoorig', 'value'=>$c_archivo_original, 'class'=>'form-control ace-file-input'));?>
                  </div>
                  <div class="col-sm-1">
                  ...
                  <!-- <div class="col-sm-2">
                   <?= anchor(base_url().'/'.$c_archivo_original, '<i class="ti-printer"></i>', array('class'=>'btn btn-circle btn-outline-success','style'=>'width: 30px; height: 30px; padding: 2px 1px;font-size: 18px;','target'=>'_blank'));?>
                  </div> -->
