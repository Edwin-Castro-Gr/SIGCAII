		      ...
		      <div class="d-flex justify-content-between flex-column flex-sm-row mb-3 px-2 px-sm-0">
		        ...
		        <div class="mb-2 mb-sm-0">
		        	<div class="row mr-1">
			          ...
			          <a href="<?php echo base_url('r_actas/nuevo')?>">
				          <button type="button" class="btn btn-blue px-3 d-block text-95 radius-round border-2 brc-black-tp10" id="btn_nueva_acta">
				            <i class="fa fa-plus mr-1"></i>
				            <span class="d-sm-none d-md-inline" id="btn_nueva_acta">Nuevo</span>
				          </button>
			          </a>
		          </div>
		        </div>
				      ...
				      <table id="simple-table" class="table border-0 table-bordered brc-black-tp11 bgc-white" style="width:100%">
				        <thead class="sticky-nav text-secondary-m1 text-uppercase text-85">
				        	<tr>
		                      ...
		                      <th class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm">Fecha Comité</th>
		                      <th class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm">Nombre del Comité</th>
		                      <th class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm">Anfitrión del Comité</th>
