			...
			<div class="card dcard">
			  <div class="card-body px-1 px-md-3">
			    <!--form autocomplete="off"-->
				  ...
				  <?= form_open(base_url('r_resultadosDx/guardar'), array('id'=>'form_guardar', 'name'=>'form_guardar', 'class'=>'', 'autocomplete'=>'off')); ?>
                ...
                <div class="form-group row" id="div_examen" >
                  ...
                  <div class="col-sm-5">
                    <?= select_examenes_tabla('resultados','','select2  form-control style="width: 100%"');?>
                  </div>                  
                </div>

                <div class="form-group row" id="div_paciente" >
                  <?= form_input(array('type'=>'hidden', 'name'=>'idpaciente', 'id'=>'idpaciente', 'value'=>'0'));?> 
                  <?= form_input(array('type'=>'hidden', 'name'=>'correopaciente', 'id'=>'correopaciente', 'value'=>''));?>                    
                  <div class="col-sm-2 col-form-label text-sm-right pr-0">
                  ...
                  <div class="col-sm-2 col-form-label text-sm-right pr-0">
			            ...
			            <div class="col-sm-4">
			            	<?= form_upload(array('type'=>'file', 'name'=>'archivov', 'id'=>'archivov', 'placeholder'=>'Cargar el Archivo del Resultado', 'class'=>'form-control ace-file-input col-sm-8 col-md-10', 'required'=>true));?>
			            </div>
                  ...
                  <div class="col-sm-3">
                    <?= form_input(array('type' => 'date', 'name' => 'txtfechaE', 'id' => 'txtfechaE',  'data-date-format'=>'dd-mm-yyyy','class' => 'form-control col-sm-9 col-md-10')); ?>
                  </div>  
				       	</div>
                  ...
                  <div class="col-sm-4">
                    ...
                    <label class="col-form-label">
                     No
                      ...
                      <?= form_input(array('type'=>'checkbox', 'name'=>'ck_enviarcorreo', 'id'=>'ck_enviarcorreo', 'class'=>'ace-switch input-md text-grey-l1 brc-primary-d1', 'required'=>true));?>
