        ...
        <div class="card-body px-3 pb-1">
            ...
            <div class="form-body " style=" justify-content:flex-start;" >
              ...
              <div class="form-group row" id="div_subprocesos">
                  ...
                  <div class="col-sm-4">
                     <?= form_dropdown('proceso',$opcproceso, '', 'class = "form-control " id="proceso"');?>
                  </div>
                  <div class="col-sm-2 col-form-label text-sm-right pr-0">
              ...
              <div class="form-group row" id="div_aso_documentos">                            
                ...
                <div class="col-sm-4 " id='divdoc_relacionado' >
                    <?= form_dropdown('doc_relacionado[]', $opcdocrela, '', 'class="select2 multiple="multiple form-control id="doc_relacionado"');?>
                </div>                   
              </div>
