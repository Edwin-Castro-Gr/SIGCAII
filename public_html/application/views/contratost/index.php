			    ...
			    <!--form autocomplete="off"-->
			      <div class="d-flex justify-content-between flex-column flex-sm-row mb-3 px-2 px-sm-0">
			        <h3 class="text-125 pl-1 mb-3 mb-sm-0 text-secondary-d4">
			          Listado de Contratos con Terceros
			        </h3>
			        ...
			        <div class="mb-2 mb-sm-0">
			          ...
			          <button type="button" class="btn btn-green px-3 d-block text-95 radius-round border-2 brc-black-tp10 mr-1 ml-2" id="btn_conr">
			            <i class="fa fa-file-pdf mr-1"></i>
			            <span class="d-sm-none d-md-inline" id="btn_conr">Lista Restrictiva</span>
			          </button>
			          <button type="button" class="btn btn-yellow px-3 d-block text-95 radius-round border-2 brc-black-tp10 mr-1" id="btn_excel">
			           ...
			           <a href="<?php echo base_url('d_contratost/nuevo')?>">
			          <button type="button" class="btn btn-blue px-3 d-block text-95 radius-round border-2 brc-black-tp10" id="btn_nuevo_contratot">
			            <i class="fa fa-plus mr-1"></i>
			            <span class="d-sm-none d-md-inline" id="btn_nuevo_contratot">Nuevo</span>
			          </button>
			          </a>
			          </div>
			        </div>
					      ...
					      <table id="simple-table" class="table border-0 table-bordered brc-black-tp11 bgc-white" style="width:100%">
					        <thead class="sticky-nav text-secondary-m1 text-uppercase text-85">
					        	<tr>
			                      ...
			                      <th class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm">Objeto</th>
			                      <th class="border-0 bgc-white bgc-h-yellow-l3 shadow-sm">Fecha de Inicio</th>		                      
