                        ...
                        <div id="smartwizard" dir="rtl-">
                          ...
                          <div class="tab-content">
                            ...
                            <div id="step-3" class="text-center tab-pane" role="tabpanel" aria-labelledby="step-3">
                              <form id="form-3" metodo="post" accion="<?= base_url('suceso_seguridad/guardar'); ?>" class="row row-cols-1 ms-5 me-5 needs-validation" novalidate>

                                <!-- Etiquetas ocultas para el que el formulario pueda guardar la informacion de los 2 steeps -->

                                <!-- Etiquetas del steep 1 -->
                                <?= form_input(array('type' => 'hidden', 'name' => 'formulariosucesos', 'id' => 'formulariosucesos', 'value' => true)); ?>
