...
<input type="hidden" name="opc_pag" id="opc_pag" value="ejecutar">
        ...
        <div class="col-12">
            <div class="card dcard">
                <div class="card-body px-3 pb-1">
                    <?= form_open(base_url('m_solicitud/guardar_programacion'), array('id' => 'form_ejecutar', 'name' => 'form_ejecutar', 'class' => 'mt-lg-3', 'autocomplete' => 'off')); ?>
                    ...
                    <div class="form-body " style=" justify-content:flex-start;">
                        ...
                        <div class="form-group row " id="div_observacionesE">
                            ...
                            <div class="col-sm-10">
                                <?= form_textarea(array('rows' => '3', 'name' => 'observacionesE', 'id' => 'observacionesE', 'placeholder' => 'Registre las observaciones a que haya lugar', 'class' => 'form-control ', 'value' => '')); ?>
                            </div>
                        </div>

                        <div class="mt-5 border-t-1 bgc-secondary-l4 brc-secondary-l2 py-35 mx-n25">
                            <div class="offset-md-3 col-md-9 text-nowrap">
                                <?= form_button(array('type' => 'button', 'id' => 'btn_Gejecutar', 'name' => 'btn_Gejecutar', 'content' => '<i class="fa fa-check mr-1"></i>Guardar', 'class' => 'btn btn-info btn-bold px-4')); ?>
