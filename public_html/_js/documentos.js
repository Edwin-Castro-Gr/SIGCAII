$(function() {
  ...
  function generar_consecutivo(tipod, clase, macro,idproce,idsubproce,docrelacionado){
    $('#codigo').val("");
    let idmacro = macro;     
    let proce = idproce;
  ...
  $(document).on("change", function(event) {
    ...
    if (dato == "solicitudesd_documentos") {
      ...
      if(idsol=="00"){
        ...
        $.post("/a_documentos/cargarsolicitud", {idsol: "" + idsol + ""}, function(data_preg) {
          ...
          generar_consecutivo(id_tipo,id_clase,id_macro,id_proceso,id_subproceso,id_docrelacionado);    
        });        
    ...
    if(dato == "tipodocumentos_documento"){
      ...
      if(ban0==1){
        ...
        let id_macro = $('#macroprocesos_documento').val();
        let id_proceso = "";
        let id_subproceso="";
        if ($('#proceso_documento').val() !="999"){
          id_proceso = $('#proceso_documento').val();
          
        }
        if ($('#subproceso_documento').val()!="999"){
          id_subproceso = $('#subproceso_documento').val();
        }
        let id_tipo = $('#tipodocumentos_documento').val();  
        let id_docrelacionado=$('#doc_relacionados').val();
    ...
    if(dato=="clase_documento"){
      ...
      if(id_clase=="5"){
        ...
        let id_proceso ="";
        let id_subproceso = "";
        let id_docrelacionao="";
        generar_consecutivo(id_tipo,id_clase,id_macro,id_proceso,id_subproceso,id_docrelacionao);       
      }
    ...
    if(dato == "doc_relacionados") {
      ...
      if ($('#proceso_documento option:selected').val() ==null|| $('#proceso_documento option:selected').val()=="999"){
        id_proceso = "";        
      }else{
        id_proceso = $('#proceso_documento option:selected').val(); 
      }
      ...
      if($('#doc_relacionados option:selected').val()==null || $('#doc_relacionados option:selected').val()=="999"){
        id_docrelacionado = ""
      }else{
